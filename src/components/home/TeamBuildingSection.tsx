...
const FEATURES: { d: string; text: string }[] = [
  ...
  { d: 'M6 10V7a6 6 0 0 1 12 0v3M5 10h14v10H5zM12 14v3', text: 'Samo vaš tim — privatno' },
  { d: 'M3 18v-6a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v6M3 18h18M3 18v2M21 18v2M7 10V8a2 2 0 0 1 2-2h6a2 2 0 0 1 2 2v2', text: 'Opcija prenoćišta u hotelu' },
  { d: 'M7 3h10a1 1 0 0 1 1 1v16l-3-2-3 2-3-2-3 2V4a1 1 0 0 1 1-1ZM9 8h6M9 12h6', text: 'Faktura za firmu' },
  { d: 'M12 3c1.5 2.5 3 4 3 6.5a3 3 0 0 1-6 0c0-1 .4-1.8 1-2.5M12 21a6 6 0 0 0 6-6c0-3-2-5.5-6-9-4 3.5-6 6-6 9a6 6 0 0 0 6 6Z', text: 'Pizza radionica za tim' },
  { d: 'M5 11l1.5-4.5A2 2 0 0 1 8.4 5h7.2a2 2 0 0 1 1.9 1.5L19 11M5 11h14v5a1 1 0 0 1-1 1h-1a1 1 0 0 1-1-1v-1H8v1a1 1 0 0 1-1 1H6a1 1 0 0 1-1-1v-5ZM7.5 14h.01M16.5 14h.01', text: 'Besplatni parking' },
];
      ...
      <div className="max-w-7xl mx-auto md:grid md:grid-cols-2 md:items-stretch">
        ...
        <div className="px-5 md:px-12 py-14 md:py-24 flex flex-col justify-center order-2 md:order-1" style={{ maxWidth: 580 }}>
          ...
          <h2 className="font-display mt-4" style={{ fontWeight: 500, fontSize: 'var(--text-d-xl)', color: '#fff', lineHeight: 1.08, marginBottom: 18 }}>
            Team building uz pravu picu
          </h2>
          <p style={{ fontSize: 16, color: 'rgba(255,255,255,0.62)', lineHeight: 1.65, marginBottom: 36 }}>
            Ceo dan za vašu firmu: bazen, sala i zabava, uz pizza radionicu koja spaja tim.
            Majstori iz picerije Majstor i Margarita vode radionicu, a vi se opustite.
            Za udaljenije timove — opcija prenoćišta u obližnjem hotelu.
          </p>
