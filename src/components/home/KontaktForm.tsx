...
export default function KontaktForm() {
  ...
  if (status === 'success') return (
    <div className="p-6 bg-[#2D6A4F]/10 border border-[#2D6A4F]/30 rounded-sm text-center">
      <p className="text-2xl mb-2">✅</p><p className="font-medium text-[#1C1C1E]">Poruka poslata!</p>
