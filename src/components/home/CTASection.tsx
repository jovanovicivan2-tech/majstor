  ...
  return (
    <section className="bg-[#F7F2EA] px-5 md:px-10 py-20 text-center">
      ...
      <Link href={`${prefix}/rezervacija`}
        className="inline-flex items-center gap-2.5 bg-[#5C1A2E] text-white text-sm font-semibold tracking-[0.08em] uppercase px-9 h-14 rounded-sm hover:bg-[#7A2440] transition-all hover:-translate-y-0.5">
