...
const FB: Package[] = [
  { id: '1', slug: 'pizza-kurs', name_sr: 'Kurs za pizza majstore', name_en: null, description_sr: 'Jednodnevni intenziv napolitanske pice uz majstore picerije Majstor i Margarita.', description_en: null, includes: ['Ceo dan obuke', 'Razvlačenje, filovanje, pečenje', 'Svi sastojci i oprema', 'Vaša pica uz piće, pored bazena'], base_price_rsd: 14999, price_per_person_rsd: 14999, min_guests: 1, max_guests: 30, duration_hours: 8, deposit_percentage: 30, is_active: true, sort_order: 1, created_at: '' },
  { id: '2', slug: 'proslave', name_sr: 'Proslave i rođendani', name_en: null, description_sr: 'Neograničeno pice i pića za svakog gosta, uz korišćenje bazena i celog prostora.', description_en: null, includes: ['Neograničeno pice za svakog gosta', 'Neograničeno piće', 'Korišćenje bazena i prostora', 'Mogućnost: gosti sami prave picu'], base_price_rsd: 5999, price_per_person_rsd: 5999, min_guests: 5, max_guests: 50, duration_hours: 6, deposit_percentage: 30, is_active: true, sort_order: 2, created_at: '' },
];
