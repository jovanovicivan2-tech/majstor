          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              <a href="tel:+381653877777" className="card-hover flex items-center gap-4" style={{ padding: 18, background: '#fff', borderRadius: 8, boxShadow: 'var(--shadow-soft)', textDecoration: 'none' }}>
                ...
                <div><p style={{ fontSize: 11, textTransform: 'uppercase', letterSpacing: '0.1em', color: '#8A7E72', marginBottom: 2 }}>Telefon</p><p style={{ fontWeight: 500, color: '#1C1C1E' }}>065 387 7777</p></div>
              </a>

              <a href="mailto:jovanovicivan2@gmail.com" className="card-hover flex items-center gap-4" style={{ padding: 18, background: '#fff', borderRadius: 8, boxShadow: 'var(--shadow-soft)', textDecoration: 'none' }}>
                <span className="inline-flex items-center justify-center shrink-0" style={{ width: 46, height: 46, borderRadius: 8, background: 'rgba(92,26,46,0.08)' }}>
